...
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/HouseOftheFreak"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/freaklair"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://freakhouse.dev/FreakChain/whitepaper.pdf"));
}

void BitcoinGUI::roadmapActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://freakhouse.dev/FreakChain/roadmap.pdf"));
}
